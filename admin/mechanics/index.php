...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="?page=mechanics/manage_mechanic" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  Crear Nuevo</a>
		</div>
	</div>
	<div class="card-body">
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("¿Está seguro de eliminar este mecánico permanentemente?","delete_mechanic",[$(this).attr('data-id')])
		})
		$('.table').dataTable();
	})
