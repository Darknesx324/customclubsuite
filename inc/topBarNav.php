<nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="topNavBar">
            <div class="container px-4 px-lg-5 ">
                ...
                <img src="<?php echo validate_image($_settings->info('logo')) ?>" width="40" height="40" class="d-inline-block align-top" alt="" loading="lazy" style="border-radius: 50%; box-shadow: 0 4px 10px rgba(0,0,0,0.2);">
                <span style="font-weight: 700; font-size: 1.3rem; text-shadow: 2px 2px 4px rgba(0,0,0,0.2);"><?php echo $_settings->info('short_name') ?></span>
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item"><a class="nav-link" href="./?p=about">Acerca de Nosotros</a></li>
                    </ul>
