 ...
 <header class="py-5" id="main-header">
    <div class="container h-100 d-flex align-items-end justify-content-center w-100">
        <div class="text-center text-white w-100">
            ...
            <p class="lead fw-normal text-white-50 mb-0">Cuidaremos de tu auto</p>
            <div class="col-auto mt-2">
                <button class="btn btn-primary btn-lg rounded-0" id="send_request" type="button">Enviar Solicitud de Servicio</button>
            </div>
        </div>
    </div>
</header>
...
<section class="py-5">
    <div class="container px-4 px-lg-5 mt-5">
        <div class="row">
            <div class="col-md-4">
                <h3 class="text-center">Ofrecemos Servicio Para:</h3>
                <hr style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); height: 4px; border-radius: 10px; opacity: 1; border: none;">
                <ul class="list-group">
                    <?php 
            ...
            <div class="col-md-8">
                ...
                <div class="input-group mb-3">
                    <input type="search" id="search" class="form-control" placeholder="Buscar Servicio Aquí" aria-label="Buscar Servicio Aquí" aria-describedby="basic-addon2">
...
<script>
    $(function(){
        ...
        $('#service_list .view_service').click(function(){
            uni_modal("Detalles del Servicio","view_service.php?id="+$(this).attr('data-id'),'mid-large')
        })
        $('#send_request').click(function(){
            uni_modal("Completar el Formulario de Solicitud de Servicio","send_request.php",'large')
        })
